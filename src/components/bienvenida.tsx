...
const Bienvenida: React.FC = () => {
    ...
    return (
        <body className="h-auto flex justify-start items-center bg-[url('src/assets/Merged-fleets.jpg')] bg-auto bg-cover bg-no-repeat bg-center bg-black/50 bg-blend-multiply h-65 overflow-hidden">
            <div className="mt-3 mb-3 ml-8 w-full max-w-2xl bg-[#e8e8e8] p-8 shadow-lg rounded-lg border-2 border">
                ...
                <button className="mt-6 px-6 py-3 bg-[#2e9700] text-white font-semibold rounded-lg shadow-md hover:bg-[#38761d] transition-all">
                    Solicitar Ruta
                </button>
